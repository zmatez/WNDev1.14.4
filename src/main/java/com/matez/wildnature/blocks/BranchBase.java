...
public class BranchBase extends VWallBlock {
    ...
    public void neighborChanged(BlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos, boolean isMoving) {
        ...
        boolean flag = this.func_220113_a(blockstate, blockstate.func_224755_d(worldIn, blockpos1, Direction.SOUTH), Direction.SOUTH);
        boolean flag1 = this.func_220113_a(blockstate1, blockstate1.func_224755_d(worldIn, blockpos2, Direction.WEST), Direction.WEST);
        boolean flag2 = this.func_220113_a(blockstate2, blockstate2.func_224755_d(worldIn, blockpos3, Direction.NORTH), Direction.NORTH);
        boolean flag3 = this.func_220113_a(blockstate3, blockstate3.func_224755_d(worldIn, blockpos4, Direction.EAST), Direction.EAST);
        boolean flag4 = this.func_220113_a(blockstate4, blockstate4.func_224755_d(worldIn, blockpos5, Direction.UP), Direction.UP);
        boolean flag5 = this.func_220113_a(blockstate5, blockstate5.func_224755_d(worldIn, blockpos6, Direction.DOWN), Direction.DOWN);
