...
public class VWallBlock extends SixWayBlock implements IWaterLoggable {
   ...
   public BlockState getStateForPlacement(BlockItemUseContext context) {
      ...
      boolean flag4 = this.func_220113_a(blockstate4, blockstate4.func_224755_d(iworldreader, blockpos5, Direction.UP), Direction.UP);
      boolean flag5 = this.func_220113_a(blockstate5, blockstate5.func_224755_d(iworldreader, blockpos6, Direction.DOWN), Direction.DOWN);
   ...
   public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
      ...
      boolean flag4 = facing == Direction.UP ? this.func_220113_a(facingState, facingState.func_224755_d(worldIn, facingPos, direction), direction) : stateIn.get(UP);
      boolean flag5 = facing == Direction.DOWN ? this.func_220113_a(facingState, facingState.func_224755_d(worldIn, facingPos, direction), direction) : stateIn.get(DOWN);
