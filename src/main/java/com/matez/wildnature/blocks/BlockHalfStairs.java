...
public class BlockHalfStairs extends BlockBase implements IWaterLoggable {
    ...
    public boolean getTypeCycle(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult rayTraceResult, int setMaxType, IntegerProperty getProperty) {
