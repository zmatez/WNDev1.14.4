...
public class WildNatureDimension extends OverworldDimension {
    ...
    public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
        ...
        OverworldBiomeProviderSettings overworldbiomeprovidersettings1 = bpt.createSettings().setGeneratorSettings(new WNGenSettings()).setWorldInfo(world.getWorldInfo());
