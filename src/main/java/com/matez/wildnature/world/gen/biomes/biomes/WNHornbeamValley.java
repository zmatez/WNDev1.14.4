...
public class WNHornbeamValley extends WNBiome {
    public WNHornbeamValley(String name) {
        ...
        WNBiomeFeatures.addTree(this,new hazel1(NoFeatureConfig::deserialize,true),4);
        WNBiomeFeatures.addTree(this,new hazel2(NoFeatureConfig::deserialize,true),4);
        WNBiomeFeatures.addTree(this,new hazel3(NoFeatureConfig::deserialize,true),4);
        WNBiomeFeatures.addTree(this,new hazel4(NoFeatureConfig::deserialize,true),4);
