...
public class oaklands_shrub8 extends SchemFeature {
    public oaklands_shrub8(Function<Dynamic<?>, ? extends NoFeatureConfig> config, boolean doBlockNofityOnPlace) {
        super(config, doBlockNofityOnPlace);
        Main.treesList.add(this);
    }

    public oaklands_shrub8(Function<Dynamic<?>, ? extends NoFeatureConfig> config, boolean doBlockNofityOnPlace, BlockState log, BlockState leaves) {
        super(config, doBlockNofityOnPlace);
        Main.treesList.add(this);
        LOG = log;
        LEAVES =leaves;
...
Block(3,1,0,"minecraft:birch_leaves[distance=4,persistent=true]");
...
Block(1,2,3,"minecraft:birch_leaves[distance=4,persistent=true]");
Block(2,2,3,"minecraft:birch_leaves[distance=5,persistent=true]");
Block(3,2,3,"minecraft:birch_leaves[distance=6,persistent=true]");
