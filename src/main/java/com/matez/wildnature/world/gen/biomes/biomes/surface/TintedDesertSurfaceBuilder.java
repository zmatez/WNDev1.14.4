...
public class TintedDesertSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
   ...
   public void buildSurface(Random random, IChunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise, BlockState defaultBlock, BlockState defaultFluid, int seaLevel, long seed, SurfaceBuilderConfig config) {
      ...
      SurfaceBuilderConfig w = new SurfaceBuilderConfig(Main.getBlockByID("wildnature:sand_white").getDefaultState(),Main.getBlockByID("wildnature:white_sand").getDefaultState(),config.getUnderWaterMaterial());
