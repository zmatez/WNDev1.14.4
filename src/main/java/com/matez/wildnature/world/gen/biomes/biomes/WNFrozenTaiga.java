...
import com.matez.wildnature.world.gen.feature.WNLeafFreezeFeature;
...
public class WNFrozenTaiga extends WNBiome {
    public WNFrozenTaiga(String name) {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(new WNLeafFreezeFeature(CountConfig::deserialize),new CountConfig(10), Placement.COUNT_BIASED_RANGE, new CountRangeConfig(50, 60, 0, 150)));
        ...
        WNBiomeFeatures.addTree(this,new tree_fir13(NoFeatureConfig::deserialize,true,Main.getBlockByID("minecraft:spruce_log").getDefaultState(), SchemFeature.notDecayingLeaf(Main.getBlockByID("wildnature:fir_leaves"))),5);
        WNBiomeFeatures.addTree(this,new tree_fir25(NoFeatureConfig::deserialize,true,Main.getBlockByID("minecraft:spruce_log").getDefaultState(), SchemFeature.notDecayingLeaf(Main.getBlockByID("wildnature:fir_leaves"))),5);
        WNBiomeFeatures.addTree(this,new tree_fir23(NoFeatureConfig::deserialize,true,Main.getBlockByID("minecraft:spruce_log").getDefaultState(), SchemFeature.notDecayingLeaf(Main.getBlockByID("wildnature:fir_leaves"))),2);
        WNBiomeFeatures.addTree(this,new tree_fir22(NoFeatureConfig::deserialize,true,Main.getBlockByID("minecraft:spruce_log").getDefaultState(), SchemFeature.notDecayingLeaf(Main.getBlockByID("wildnature:fir_leaves"))),5);
