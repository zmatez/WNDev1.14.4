...
public class WildNatureBiomeProvider extends OverworldBiomeProvider {
    ...
    public WildNatureBiomeProvider(OverworldBiomeProviderSettings settingsProvider) {
        ...
        Layer[] alayer = WNLayerUtil.buildOverworldProcedure(worldinfo.getSeed(), worldinfo.getGenerator(), overworldgensettings);
