...
public class WNBeechValley extends WNBiome {
    public WNBeechValley(String name) {
        ...
        this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, Biome.createDecoratedFeature(new WNBlobFeature(WNBlobConfig::deserialize), new WNBlobConfig(Blocks.PODZOL.getDefaultState(),1,true,false), Placement.FOREST_ROCK, new FrequencyConfig(1)));
