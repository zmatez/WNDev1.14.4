...
public class WNDenseOaklands extends WNBiome {
    public WNDenseOaklands(String name) {
        ...
        WNBiomeFeatures.addTree(this,new oaklands_oak1(NoFeatureConfig::deserialize,true),3);
        WNBiomeFeatures.addTree(this,new oaklands_oak2(NoFeatureConfig::deserialize,true),3);
        WNBiomeFeatures.addTree(this,new oaklands_oak3(NoFeatureConfig::deserialize,true),3);
        WNBiomeFeatures.addTree(this,new oaklands_oak4(NoFeatureConfig::deserialize,true),3);
        WNBiomeFeatures.addTree(this,new oaklands_oak5(NoFeatureConfig::deserialize,true),3);
        WNBiomeFeatures.addTree(this,new oaklands_oak6(NoFeatureConfig::deserialize,true),3);
        WNBiomeFeatures.addTree(this,new oaklands_oak7(NoFeatureConfig::deserialize,true),3);
        WNBiomeFeatures.addTree(this,new oaklands_oak8(NoFeatureConfig::deserialize,true),3);
        ...
        WNBiomeFeatures.addTree(this,new oaklands_shrub3(NoFeatureConfig::deserialize,true),1);
        WNBiomeFeatures.addTree(this,new oaklands_shrub4(NoFeatureConfig::deserialize,true),1);
