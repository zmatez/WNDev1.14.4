...
public class GrandCanyonSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
    ...
    private SurfaceBuilder<SurfaceBuilderConfig> b;

    public GrandCanyonSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> p_i51312_1_, SurfaceBuilder<SurfaceBuilderConfig> b) {
        super(p_i51312_1_);
        this.b=b;
    ...
    public void buildSurface(Random random, IChunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise, BlockState defaultBlock, BlockState defaultFluid, int seaLevel, long seed, SurfaceBuilderConfig config) {
        ...
        b.setSeed(seed);
        b.buildSurface(random, chunkIn, biomeIn, x, z, realY, noise, defaultBlock, defaultFluid, seaLevel, seed, config);
        b.buildSurface(random, chunkIn, biomeIn, x, z, realY1, noise, defaultBlock, defaultFluid, seaLevel, seed, config);
        b.buildSurface(random, chunkIn, biomeIn, x, z, realY2, noise, defaultBlock, defaultFluid, seaLevel, seed, config);
        b.buildSurface(random, chunkIn, biomeIn, x, z, realY3, noise, defaultBlock, defaultFluid, seaLevel, seed, config);
        b.buildSurface(random, chunkIn, biomeIn, x, z, realY4, noise, defaultBlock, defaultFluid, seaLevel, seed, config);
        b.buildSurface(random, chunkIn, biomeIn, x, z, realY5, noise, defaultBlock, defaultFluid, seaLevel, seed, config);
