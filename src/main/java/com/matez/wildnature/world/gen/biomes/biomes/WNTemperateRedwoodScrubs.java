...
public class WNTemperateRedwoodScrubs extends WNBiome {
    public WNTemperateRedwoodScrubs(String name) {
        ...
        WNBiomeFeatures.addTree(this,new pointy_birch1(NoFeatureConfig::deserialize,true),2);
        WNBiomeFeatures.addTree(this,new pointy_birch2(NoFeatureConfig::deserialize,true),2);
        WNBiomeFeatures.addTree(this,new pointy_birch3(NoFeatureConfig::deserialize,true),2);
        WNBiomeFeatures.addTree(this,new pointy_birch4(NoFeatureConfig::deserialize,true),2);
        WNBiomeFeatures.addTree(this,new pointy_oak_1(NoFeatureConfig::deserialize,true),2);
        ...
        WNBiomeFeatures.addTree(this,new wild_cherry4(NoFeatureConfig::deserialize,true),1);
        WNBiomeFeatures.addTree(this,new magnolia4(NoFeatureConfig::deserialize,true),1);
