...
public class WNTemperatePineMixedForest extends WNBiome {
    public WNTemperatePineMixedForest(String name) {
        ...
        WNBiomeFeatures.addTree(this,new oaklands_shrub3(NoFeatureConfig::deserialize,true),2);
        ...
        WNBiomeFeatures.addTree(this,new cherry3(NoFeatureConfig::deserialize,true),1);
