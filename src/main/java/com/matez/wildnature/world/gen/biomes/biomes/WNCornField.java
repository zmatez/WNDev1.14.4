...
import com.matez.wildnature.world.gen.feature.CornGrassFeature;
...
public class WNCornField extends WNBiome {
    public WNCornField(String name) {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(new CornGrassFeature(NoFeatureConfig::deserialize), new NoFeatureConfig(), Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(80)));
        ...
        WNBiomeFeatures.addPlant(this,Main.getBlockByID("minecraft:grass").getDefaultState(),6);
