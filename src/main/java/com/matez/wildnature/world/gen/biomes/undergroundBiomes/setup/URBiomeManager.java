...
import com.matez.wildnature.world.gen.biomes.undergroundBiomes.*;
...
public class URBiomeManager {
    ...
    public static URBiome getBiomeAt(IChunk chunk, BlockPos pos, long seed){
        Biome.Category category = chunk.getBiome(pos).getCategory();
        Biome.TempCategory tempCategory = chunk.getBiome(pos).getTempCategory();
