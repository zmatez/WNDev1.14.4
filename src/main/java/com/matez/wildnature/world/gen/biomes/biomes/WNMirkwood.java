...
public class WNMirkwood extends WNBiome {
    public WNMirkwood(String name) {
        ...
        WNBiomeFeatures.addTree(this,new spooky_big1(NoFeatureConfig::deserialize,true),2);
        WNBiomeFeatures.addTree(this,new spooky_big2(NoFeatureConfig::deserialize,true),2);
        WNBiomeFeatures.addTree(this,new spooky_big3(NoFeatureConfig::deserialize,true),2);
        WNBiomeFeatures.addTree(this,new spooky_big4(NoFeatureConfig::deserialize,true),2);
        WNBiomeFeatures.addTree(this,new spooky_big5(NoFeatureConfig::deserialize,true),2);
        WNBiomeFeatures.addTree(this,new spooky_big6(NoFeatureConfig::deserialize,true),2);
        WNBiomeFeatures.addTree(this,new spooky_big7(NoFeatureConfig::deserialize,true),2);
        WNBiomeFeatures.addTree(this,new spooky_big8(NoFeatureConfig::deserialize,true),2);
