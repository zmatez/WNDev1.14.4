...
public class LavalilyFeature extends Feature<NoFeatureConfig> {
   private Block waterlily;
   public LavalilyFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51416_1_, Block waterlily) {
      super(p_i51416_1_);
