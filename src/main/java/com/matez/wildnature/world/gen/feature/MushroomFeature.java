...
public class MushroomFeature extends Feature<NoFeatureConfig> {
    private BlockWeighList list;
    public MushroomFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i49869_1_, BlockWeighList list) {
        super(p_i49869_1_);
        this.list=list;
    }
