...
public class WNTaigaMarsh extends WNBiome {
    public WNTaigaMarsh(String name) {
        ...
        WNBiomeFeatures.addTree(this,new thin_birch1(NoFeatureConfig::deserialize,true),6);
        WNBiomeFeatures.addTree(this,new thin_birch2(NoFeatureConfig::deserialize,true),6);
        WNBiomeFeatures.addTree(this,new thin_birch3(NoFeatureConfig::deserialize,true),6);
        WNBiomeFeatures.addTree(this,new thin_birch4(NoFeatureConfig::deserialize,true),6);
