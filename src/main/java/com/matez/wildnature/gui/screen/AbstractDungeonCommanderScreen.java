...
public abstract class AbstractDungeonCommanderScreen extends Screen {
   ...
   protected AbstractDungeonCommanderScreen.SuggestionsList suggestionList;
   ...
   public void func_209109_s() {
      if (this.field_209115_x != null && this.field_209115_x.isDone()) {
         ...
         if (!suggestions.isEmpty()) {
            ...
            this.suggestionList = new AbstractDungeonCommanderScreen.SuggestionsList(j, 72, i, suggestions);
         }
      }
   ...
   class SuggestionsList {
      ...
      private SuggestionsList(int p_i49843_2_, int p_i49843_3_, int p_i49843_4_, Suggestions p_i49843_5_) {
         ...
         this.field_212467_d = AbstractDungeonCommanderScreen.this.commandTextField.getText();
         this.suggest(0);
      }
      ...
      public void render(int mouseX, int mouseY) {
         ...
         for(int i1 = 0; i1 < i; ++i1) {
            ...
            AbstractDungeonCommanderScreen.this.font.drawStringWithShadow(suggestion.getText(), (float)(this.bounds.getX() + 1), (float)(this.bounds.getY() + 2 + 12 * i1), i1 + this.scrollAmount == this.selectedSuggestion ? -256 : -5592406);
         }

         if (flag4) {
            Message message = this.suggestions.getList().get(this.selectedSuggestion).getTooltip();
            if (message != null) {
               AbstractDungeonCommanderScreen.this.renderTooltip(TextComponentUtils.toTextComponent(message).getFormattedText(), mouseX, mouseY);
            }
         }
      ...
      public boolean mouseScrolled(double amount) {
         int i = (int)(AbstractDungeonCommanderScreen.this.minecraft.mouseHelper.getMouseX() * (double) AbstractDungeonCommanderScreen.this.minecraft.mainWindow.getScaledWidth() / (double) AbstractDungeonCommanderScreen.this.minecraft.mainWindow.getWidth());
         int j = (int)(AbstractDungeonCommanderScreen.this.minecraft.mouseHelper.getMouseY() * (double) AbstractDungeonCommanderScreen.this.minecraft.mainWindow.getScaledHeight() / (double) AbstractDungeonCommanderScreen.this.minecraft.mainWindow.getHeight());
      ...
      public void suggest(int suggestionIndex) {
         ...
         AbstractDungeonCommanderScreen.this.commandTextField.setSuggestion(AbstractDungeonCommanderScreen.func_212339_b(AbstractDungeonCommanderScreen.this.commandTextField.getText(), suggestion.apply(this.field_212467_d)));
      }
      ...
      public void applySuggestion() {
         ...
         AbstractDungeonCommanderScreen.this.commandTextField.setSelectionPos(i);
