...
public class OreRegistry {
    ...
    public OreRegistry(){
        ores = new Block[]{
                WNBlocks.TIN_ORE= new BlockBase(Block.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).hardnessAndResistance(3F).harvestLevel(1),new Item.Properties().group(Main.WILDNATURE_UNDERGROUND_GROUP), Main.RegistryEvents.location("tin_ore")),
                ...
                WNBlocks.SILVER_ORE= new BlockBase(Block.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).hardnessAndResistance(3F).harvestLevel(2),new Item.Properties().group(Main.WILDNATURE_UNDERGROUND_GROUP), Main.RegistryEvents.location("silver_ore")),
