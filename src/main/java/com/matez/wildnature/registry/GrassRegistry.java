...
public class GrassRegistry {
    ...
    public GrassRegistry(){
        grass = new Block[]{
                ...
                WNBlocks.MOLD_GRASS_BLOCK = new GrassBase(Block.Properties.create(Material.ORGANIC, MaterialColor.GREEN).sound(SoundType.PLANT).hardnessAndResistance(0.6F).harvestTool(ToolType.SHOVEL), new Item.Properties().group(Main.WILDNATURE_GROUP), Main.RegistryEvents.location("mold_grass_block"),"wildnature:old_dirt"),
