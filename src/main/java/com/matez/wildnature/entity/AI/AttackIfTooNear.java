...
public class AttackIfTooNear extends Goal {
    ...
    public boolean shouldExecute() {
        ...
        nearest = this.entity.world.getClosestEntityWithinAABB(entity.getClass(), predicate, this.entity, this.entity.posX, this.entity.posY, this.entity.posZ, this.entity.getBoundingBox().grow(6.0D, 2.0D, 6.0D));
        return nearest!=null;
    }
