...
public class FamilyBreedGoal extends Goal {
    ...
    protected void spawnBaby() {
        ...
        if (ageableentity != null) {
            ...
            ageableentity.setLocationAndAngles(mother.posX, mother.posY, mother.posZ, 0.0F, 0.0F);
            this.world.addEntity(ageableentity);
            this.world.setEntityState(mother, (byte)18);
            if (this.world.getGameRules().getBoolean(GameRules.DO_MOB_LOOT)) {
                this.world.addEntity(new ExperienceOrbEntity(this.world, this.animal.posX, this.animal.posY, this.animal.posZ, mother.getRNG().nextInt(7) + 1));
            }
