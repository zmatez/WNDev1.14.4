 ...
 */
public class DrakeModel extends EntityModel<AbstractDuckEntity> {
    ...
    public DrakeModel() {
        ...
        this.RightLeg3 = new RendererModel(this, 0, 28);
        ...
        this.LeftLeg3 = new RendererModel(this, 0, 28);
    ...
    @Override
    public void setLivingAnimations(AbstractDuckEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
        if(entityIn.isSleeping()){
            if(entityIn.isInWater()){
                this.LeftLeg2.isHidden=false;
                this.RightLeg2.isHidden=false;
            }else{
                this.Body1.offsetY=5F;
                this.LeftLeg2.isHidden=true;
                this.RightLeg2.isHidden=true;
            }
        }else{
    ...
    public void setRotationAngles(AbstractDuckEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        }else if(((AbstractDuckEntity) entityIn).isInWater()){
            this.RightLeg2.rotateAngleX = (MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount)/6-30;
            this.LeftLeg2.rotateAngleX = (MathHelper.cos(limbSwing * 0.6662F + (float)Math.PI) * 1.4F * limbSwingAmount)/6-30;
            this.LeftWing.rotateAngleZ = 0;
            this.RightWing.rotateAngleZ = 0;
        }else{
