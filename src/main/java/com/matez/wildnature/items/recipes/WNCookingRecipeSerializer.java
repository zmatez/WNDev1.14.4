...
public class WNCookingRecipeSerializer<T extends AbstractCookingRecipe> extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T> {
   private final int field_222178_t;
   private final WNCookingRecipeSerializer.IFactory<T> field_222179_u;

   public WNCookingRecipeSerializer(WNCookingRecipeSerializer.IFactory<T> p_i50025_1_, int p_i50025_2_) {
